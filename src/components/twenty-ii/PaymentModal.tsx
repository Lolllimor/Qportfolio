...
export const PaymentModal = ({ artwork, onClose }: PaymentModalProps) => {
    ...
    const { buyArtwork } = useBuyArtwork({
        artwork,
        email,
        phone,
        firstName,
            ...
            <div className="relative max-w-[618px] w-full bg-white rounded-lg p-6 md:p-8 flex flex-col items-center max-h-[90vh] overflow-y-auto">
                ...
                >
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 1L13 13M13 1L1 13" stroke="#2C2C2C" strokeWidth="1.5" strokeLinecap="round" />
                    </svg>
                </button>

                <h2 className="text-2xl font-bold uppercase mb-6 text-center">Checkout</h2>
                ...
                <div className="w-full flex flex-col gap-4">
                    ...
                    <button
                        onClick={handlePay}
                        className="w-full bg-[#E3591C] text-white font-bold uppercase py-4 mt-4 hover:opacity-90 transition-opacity"
                    >
                        Pay Now
                    </button>
